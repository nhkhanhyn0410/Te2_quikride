  ...
  try {
    ...
    const buses = await Bus.create([
      // FUTA buses
      {
        ...
        amenities: ['wifi', 'ac', 'reclining_seats', 'blanket', 'water', 'usb_charging'],
      ...
      },
      {
        ...
        amenities: ['wifi', 'ac', 'sleeper_beds', 'blanket', 'pillow', 'water', 'usb_charging', 'tv'],
      ...
      // Thanh Bưởi buses
      {
        ...
        amenities: ['ac', 'reclining_seats', 'water'],
